    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <header className="border-b bg-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4">
            ...
            <div className="relative">
              <span className="pointer-events-none absolute inset-y-0 left-3 flex items-center text-gray-400">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
                  <path fillRule="evenodd" d="M10 3.75a6.25 6.25 0 1 0 3.9 11.2l4.55 4.55a.75.75 0 1 0 1.06-1.06l-4.55-4.55A6.25 6.25 0 0 0 10 3.75Zm-4.75 6.25a4.75 4.75 0 1 1 9.5 0 4.75 4.75 0 0 1-9.5 0Z" clipRule="evenodd" />
                </svg>
              </span>
              <input
                id="search"
          ...
          <nav className="flex items-center gap-4">
            ...
            {/* Favoritos com coração (sem função por enquanto) */}
            <button
              type="button"
              aria-label="Favoritos"
              className="flex items-center gap-2 rounded-full border border-gray-300 bg-white px-3 py-2 text-sm hover:bg-gray-50"
            >
              ...
              <span className="hidden sm:inline"></span> {/* Aqui está o coração dos favoritos */}
            </button>


            {/* Carrinho ícone*/}
            <button type="button" className="flex items-center gap-2 rounded-full border border-gray-300 bg-white px-3 py-2 text-sm hover:bg-gray-50">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
                <path d="M2.25 3a.75.75 0 0 0 0 1.5h1.386l.955 9.549A2.25 2.25 0 0 0 6.83 16.125h8.79a2.25 2.25 0 0 0 2.238-2.076l.66-7.425A.75.75 0 0 0 17.775 6H5.99l-.13-1.3A1.5 1.5 0 0 0 4.636 3H2.25Zm5.25 18a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm9-1.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z" />
              </svg>
        ...
        <div className="mx-auto max-w-7xl px-4 pb-4">
          <div className="flex flex-wrap items-center gap-2 text-sm text-gray-700">
            ...
            <ul className="flex items-center gap-2">
              <li>
                <button className="rounded-full bg-gray-100 px-3 py-1 hover:bg-gray-200">Hair</button>
              </li>
              <li>
                <button className="rounded-full bg-gray-100 px-3 py-1 hover:bg-gray-200">Skin</button>
              </li>
              <li>
                <button className="rounded-full bg-gray-100 px-3 py-1 hover:bg-gray-200">Nails</button>
              </li>
            </ul>
          </div>
        </div>
      ...
      <main className="mx-auto max-w-7xl px-4 py-6">
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
          {demoProducts.map((p) => (
            <article key={p.id} className="overflow-hidden rounded-lg border bg-white shadow-sm">
              {/* Quadrado do produto (imagem) */}
              <div className="aspect-square w-full bg-gray-100" aria-hidden>
                {/* Placeholder de imagem pq ainda não tenho*/}
              ...
              <div className="space-y-1 p-3">
                ...
                {/* Valor em Euro */}
                <p className="text-base font-semibold">€ {p.priceEUR.toFixed(2)}</p>
              </div>
            </article>
          ))}
        </div>
